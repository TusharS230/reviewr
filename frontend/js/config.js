...
const API_BASE_URL =
  window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1'
    ...
    : 'https://reviewr-1.onrender.com/api';
...
export function clearToken() {
  localStorage.removeItem('reviewr_jwt');
}
